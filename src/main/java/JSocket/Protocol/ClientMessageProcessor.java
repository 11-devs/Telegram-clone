...
import JSocket.Protocol.Authentication.AuthProcessState;
import JSocket.Protocol.Authentication.IAccessKeyManager;
import JSocket.Core.Client.ClientSession;
